...
const ProductList = () => {
    ...
    const { currency, products, fetchProducts } = useContext(ShopContext);

    const toggleStock = async (productId, inStock) => {
        try {
            const response = await axios.post('/api/product/stock', { productId, inStock });
    ...
    return (
        <div className="flex-1 h-[95vh] overflow-y-scroll flex flex-col justify-between">
            <div className="w-full md:p-10 p-4">
                ...
                <div className="flex flex-col items-center max-w-4xl w-full overflow-primary-dulldden rounded-md bg-white border border-gray-500/20">
                    <table className="md:table-auto table-fixed w-full overflow-primary-dulldden">
                            ...
                            {products.map((product) => (
                                <tr key={product._id} className="border-t border-gray-500/20">
                                    ...
                                    <td className="md:px-4 pl-2 md:pl-4 py-3 flex items-center space-x-3 truncate">
                                        <div className="border border-gray-300 rounded overflow-primary-dulldden">
